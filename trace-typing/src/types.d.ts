...
interface InfoProperties {
    ...
    type?: number // enum: TraceLanguageAST#CoerceTypes
}
...
declare type InitialFunctionTypeMaker = (signatures:SingleFunctionType[]) => FunctionType
...
interface SourceLocation {
    ...
    endColumn:number
    isPseudo:boolean
    toString(omitFile?:boolean, asRegion?:boolean, relative?:boolean):string;
}
...
interface CallStackSensitivityConfig {
    height?: number
    sensitivity: number // enum: CallStackSensitivity
}
interface PrecisionConfig {
    flowInsensitiveVariables?: boolean
    // TODO merge these options somehow...
    contextInsensitiveVariables?: boolean
    callstackSensitiveVariables?: CallStackSensitivityConfig
}
interface Target {
    dir?: string
    main: string
...
declare module "mkdirp" {
    export function sync(s:string):void
}
declare module 'mkdirp' {
...
declare module "graceful-ncp" {
    function ncp(from:string, to:string, callback:Function):void;
}
