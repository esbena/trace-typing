...
import {SourceLocationImpl} from "./SourceLocationImpl";
        ...
        switch (e.kind) {
            ...
            case "PRIMITIVE":
                var primitiveKind:AST.PrimitiveKind = (<any>{
                    symbol: AST.PrimitiveKind.Number, // FIXME modeling symbols as numbers, should be fine as long as no property accesses occur
        ...
        fs.readFile(fileName, 'utf8', function (err, traceFileContent) {
            ...
            switch (parsed.format) {
                case "naive":
                    ...
                    var outstream:NodeJS.WritableStream = undefined;
