...
export class ShapeImpl implements Shape {
    ...
    private objectClassification:ObjectClassification = undefined;
    ...
    constructor(parentOrPrototype:Value, meta:TraceElementMetaInformation, public traceIndex:number, propertyNameOrIsArray?:string|boolean, valueOrIsFunction?:Value|boolean, dynamicPropertyNameOrIsDotPrototype?:boolean, isArguments?: boolean) {
        ...
        if (parentOrPrototype !== undefined && propertyName !== undefined && value !== undefined) { // mutated object
            ...
            if (dynamicPropertyName) {
                this.objectClassification = ObjectClassification.Map;
            } else {
                this.objectClassification = ObjectClassification.Object;
            }
            ...
            if (isArray) {
                this.objectClassification = ObjectClassification.Array;
            }
            if (isArguments) {
                this.objectClassification = ObjectClassification.Arguments;
            }
            if(isFunction){
                this.objectClassification = ObjectClassification.Function;
            }
    ...
    public getObjectClassification():ObjectClassification {
