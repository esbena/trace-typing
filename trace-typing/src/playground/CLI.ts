...
function handleError(e:any) {
    ...
    console.log("Example usage: ./bin/play.sh " + "tags" + " test/fixtures/optparse-singlefile.js");
    console.log("Example usage: ./bin/play.sh " + "fixed" + " test/fixtures/optparse-singlefile.js");
    console.log();
...
try {
    ...
    new Playground.Playground().playWithoutTest({
        ...
        stdout: true,
        iidFilter: iidFilter,
        filterToBenchmarkCodeOnly: true
    }, function (e:any) {
        if (e) {
            handleError(e);
        }
